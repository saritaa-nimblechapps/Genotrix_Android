...
//                    DailogPwmValueGet();
    ...
    private fun setupViews() {
        ...
        container!!.setOnTouchListener(OnTouchListener { view, motionEvent -> //                InputMethodManager imm = (InputMethodManager) getActivity().getSystemService(INPUT_METHOD_SERVICE);
...
//            fragment,
//            GetClientIdFragment::class.java.simpleName
//        )
    }
