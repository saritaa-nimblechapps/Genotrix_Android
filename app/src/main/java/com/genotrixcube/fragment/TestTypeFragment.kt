...
import com.genotrixcube.adpter.TestTypeAdpter
import com.genotrixcube.fragment.HomeFragment
import com.genotrixcube.fragment.TestTypeFragment
...
class TestTypeFragment : Fragment {
    ...
    override fun onCreateView(
        ...
        //only change the adpter value.

        val today = TodayDate()
        txtTypeTitle!!.text =  strUserId.toString() + "-" + today
