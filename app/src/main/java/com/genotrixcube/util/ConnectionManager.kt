...
import com.genotrixcube.util.MyBleCallBackHelper.Companion.deviceGattMap
...
//                Log.e("Connect device","Connecting to ${device.name}")
                ...
                Log.wtf("mulfile","device name :"+pendingOperation!!.device.name + " callback q"+callback)
